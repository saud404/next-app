  ...
  return (
    <div>
      <section class="text-gray-600 body-font">
        <div class="max-w-5xl pb-24 mx-auto pt-52">
          <h1 class="mb-6 font-bold text-center text-white text-80 font-4 lh-6 ld-04">
            Create your next website fast and easy
          </h1>
          <h2 class="pb-5 text-2xl font-semibold text-center text-gray-700 font-4 lh-6 ld-04">
          ...
          <div class="ml-6 text-center">
            ...
            >
              <div class="flex text-lg">
                <span class="justify-center">Get a Quote</span>
              </div>
            </a>
            <a
            ...
            >
              <div class="flex text-lg">
                <span class="justify-center">Contact Us</span>
              </div>
            </a>
          </div>
        </div>

        <h2 class="pt-5 mb-1 text-2xl font-semibold tracking-tighter text-center text-gray-200 lg:text-7xl md:text-6xl">
          Benefits of working with M-Open73.
        </h2>
        <br></br>
        <p class="mx-auto text-xl font-normal leading-relaxed text-center text-gray-300 fs521 lg:w-2/3">
          Here is our collection of free to use templates made with Next.js &
          styled with Tailwind CSS.
        </p>
        <div class="max-w-4xl px-3 pt-12 pb-24 mx-auto fsac4 md:px-1">
          <div class="ktq4">
            <img class="w-10" src="https://nine4.app/favicon.png"></img>
            <h3 class="pt-3 text-lg font-semibold text-white">
              Reasonably Priced
            </h3>
            <p class="pt-2 text-gray-200 value-text text-md fkrr1">
        ...
        <div class="max-w-6xl px-3 pt-32 pb-1 mx-auto fsac4 md:px-1">
